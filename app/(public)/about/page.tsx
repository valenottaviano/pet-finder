...
import { PawPrint, Heart, Shield, Users, Target, Rocket, Code2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            PetFinder nace de la intersección entre la tecnología moderna y el amor por los animales. 
            Una solución integral para conectar mascotas perdidas con sus familias.
          </p>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                <p>
                  PetFinder es un proyecto de tesis de Ingeniería en Informática desarrollado por 
                  <strong className="text-foreground"> Valentín Ottaviano</strong>. 
                  Este trabajo académico propone una solución innovadora al problema de las mascotas perdidas.
                </p>
                <p>
                  El objetivo principal es demostrar cómo las tecnologías actuales (Geolocalización, QR, PWA) 
                  pueden aplicarse para resolver problemas reales de la comunidad, creando un sistema accesible, 
                ...
                <div className="flex items-center gap-4 pt-4">
                  ...
                  <span className="text-sm font-medium">Ingeniería en Informática</span>
                </div>
              </div>
            </div>
      ...
      <div className="py-24 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-16">Nuestros Pilares</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="bg-background p-8 rounded-3xl border border-border/50 hover:shadow-lg transition-all duration-300">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            <div className="flex flex-col items-center gap-2">
               <span className="text-4xl font-bold tracking-tighter">Next.js</span>
               <span className="text-xs text-muted-foreground">Framework</span>
            </div>
            <div className="flex flex-col items-center gap-2">
               <span className="text-4xl font-bold tracking-tighter">Prisma</span>
               <span className="text-xs text-muted-foreground">Database</span>
            </div>
            <div className="flex flex-col items-center gap-2">
               <span className="text-4xl font-bold tracking-tighter">Vercel</span>
               <span className="text-xs text-muted-foreground">Deployment</span>
            </div>
            <div className="flex flex-col items-center gap-2">
               <span className="text-4xl font-bold tracking-tighter">Stripe</span>
      ...
      <div className="py-24 px-4 sm:px-6 lg:px-8 bg-foreground text-background text-center rounded-t-[3rem] mx-4 sm:mx-8">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl text-background/80 mb-10 max-w-2xl mx-auto">
            Este proyecto está vivo y evolucionando. Tu feedback es esencial para seguir mejorando.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
             <Link href="/auth/register">
               <Button size="lg" className="bg-background text-foreground hover:bg-background/90 rounded-full px-8 h-14 text-lg font-medium">
                 Crear Cuenta
               </Button>
             </Link>
             <Link href="/contact">
               <Button size="lg" variant="outline" className="border-background/20 text-background hover:bg-background/10 rounded-full px-8 h-14 text-lg font-medium bg-transparent">
                 Contactar
               </Button>
             </Link>
          </div>
